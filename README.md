...
Originally based on [muvaf/kubernetes-apply](https://github.com/muvaf/kubernetes-apply) by Muvaffak Onus, licensed under Apache-2.0. This package has since been reworked and is maintained independently.
